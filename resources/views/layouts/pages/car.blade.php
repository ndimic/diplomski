...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h3 align="center" class="border" style="background-color: orange; color: #fff;">{{ $car->price }}
                    €</h3>
                <h3 align="center" class="border" style="background: #5aa700; color: #fff;">{{ $car->year }}.
                    godište</h3>
                <h3 align="center" class="border" style="background-color: #29aade; color: #fff;">{{ $car->km }}
                    km.</h3>
                ...
                <div align="center"><img align="center" class="img-responsive"
                                         src="{{ url('/images/' .$car->category->logo) }}" alt=""></div>
            </div>
        </div>
        <!-- /.row -->
